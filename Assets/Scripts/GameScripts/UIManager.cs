...
public class UIManager : NetworkBehaviour
{
    ...
    {
        PlayerText.GetComponent<Text>().text = "Player BP: " + GameManager.PlayerBP + "\nPlayer Value: " + GameManager.PlayerVariables 
                                            + "\nPlayer Multiplier: " + GameManager.PlayerMultiplier + "\nPlayer Score: " + GameManager.PlayerScore;
        OpponentText.GetComponent<Text>().text = "Opponent BP: " + GameManager.OpponentBP + "\nOpponent Value: " + GameManager.OpponentVariables
                                            + "\nOpponent Multiplier: " + GameManager.OpponentMultiplier + "\nOpponent Score: " + GameManager.OpponentScore;
    }
